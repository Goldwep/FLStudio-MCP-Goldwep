...
| `transport_set_song_pos`  | `transport.setSongPos(pos, mode=2)`                | 🟢    | `mode` selects unit (SONGLENGTH\_\*); mode=2 = AbsTicks.                                                  |
...
**L8 total:** 12 tools. Greens: 8 (67%). Yellows: 4 (33%). Reds: 0. **Ship as planned, with state\_\* tools gated on bridge architecture finalization.**
